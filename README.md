...
- **`randomizer-export.html`** — the character randomizer. Open it directly or
  visit the GitHub Pages URL for this repository. It rolls a complete Shadowdark
